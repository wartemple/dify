const translation = {
  ...
  apiKeyInfo: {
    ...
    usedToken: '使用 Tokens',
    setAPIBtn: '设置模型提供商',
    tryCloud: '或者尝试使用 大模型应用平台 的云版本并使用试用配额',
  },
  overview: {
    title: '概览',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: '帮助访问者了解该应用收集的数据，可参考 大模型应用平台 的<privacyPolicyLink>隐私政策</privacyPolicyLink>。',
        },
      },
      embedded: {
        entry: '嵌入',
      ...
      customize: {
        ...
        way1: {
          ...
          step1Operation: '大模型应用平台-WebClient',
          step2: '配置 Web APP',
